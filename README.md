...
Изменения v1.31: В кошельке eGOLD.html добавлена возможность делать скриншоты, для сохранения QR кода. Также добавлена дополнительная проверка на присутствие кошелька в ноде, когда уже находимся в кошельке. В ноде значительно улучшена синхронизация с другими нодами.
