...
2. Работа ноды оптимизирована для работы ноды на устройствах, находящихся за роутером, на котором прописан статический IP и нода работает через проброс порта. На ноде значительно увеличена скорость проведения транзакций и синхронизация с другими нодами. Для обновления версии ноды достаточно заменить файл egold.php.
